...
class LogSeedDataOnlineForm(forms.Form):
	...
	collection_row = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Collection Row'}), required=True)
	collection_plant = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Collection Plant'}), required=True)
