...
class LogSeedDataOnlineForm(forms.Form):
	...
	collection_row = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Collection Row'}), required=False)
	collection_plant = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Collection Plant'}), required=False)
...
class LogStockPacketOnlineForm(forms.Form):
	...
	num_seeds = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Num Seeds'}), required=True)
	packet_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Packet Comments'}), required=True)
	...
	room = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Room'}), required=True)
	shelf = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Shelf'}), required=True)
	column = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Column'}), required=True)
	box_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Box Name'}), required=True)
	location_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Location Comments'}), required=True)
...
class LogRowsOnlineForm(forms.Form):
	...
	stock = forms.ModelChoiceField(queryset=Stock.objects.all(), empty_label="--- Seed ID ---", required=True)
	field = forms.ModelChoiceField(queryset=Field.objects.all(), empty_label="--- Field Name ---", required=True)
	range_num = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Range'}), required=True)
	plot = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Plot'}), required=True)
	block = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Block'}), required=True)
	rep = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Rep'}), required=True)
	kernel_num = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Kernel Num'}), required=True)
	planting_date = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Planting Date'}), required=True)
	harvest_date = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Harvest Date'}), required=True)
	row_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=True)
...
class LogPlantsOnlineForm(forms.Form):
	...
	stock = forms.ModelChoiceField(queryset=Stock.objects.all(), empty_label="--- Seed ID ---", required=True)
	obs_row = forms.ModelChoiceField(queryset=ObsRow.objects.all(), empty_label="--- Row ID ---", required=True)
	plant_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=True)
...
class LogSamplesOnlineForm(forms.Form):
	...
	weight = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Weight'}), required=True)
	kernel_num = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Kernel Num'}), required=True)
	sample_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=True)
...
class LogEnvironmentsOnlineForm(forms.Form):
	...
	field = forms.ModelChoiceField(queryset=Field.objects.all(), empty_label="--- Field Name ---", required=True)
	longitude = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Longitude'}), required=True)
	latitude = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Latitude'}), required=True)
	environment_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=True)

class LogMeasurementsOnlineForm(forms.Form):
	obs_row = forms.ModelChoiceField(queryset=ObsRow.objects.all(), empty_label="--- Row ID ---", required=True)
	obs_plant = forms.ModelChoiceField(queryset=ObsPlant.objects.all(), empty_label="--- Plant ID ---", required=True)
	obs_sample = forms.ModelChoiceField(queryset=ObsSample.objects.all(), empty_label="--- Sample ID ---", required=True)
	obs_env = forms.ModelChoiceField(queryset=ObsEnv.objects.all(), empty_label="--- Environment ID ---", required=True)
	...
	time_of_measurement = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Time of Measurement'}), required=True)
	value = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Value'}), required=True)
	measurement_comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=True)
