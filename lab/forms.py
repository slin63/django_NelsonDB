...
class NewExperimentForm(forms.Form):
	...
	name = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Experiment Name'}), help_text="Assign an experiment name (e.g. 15XY with NO SPACES or SPECIAL CHARACTERS):", required=True)
...
class LogSamplesOnlineForm(forms.Form):
	experiment = forms.ModelChoiceField(queryset=Experiment.objects.all(), empty_label="--- Experiment ---", required=True)
	obs_sample__sample_id = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Sample ID'}), required=True)
	obs_sample__sample_type = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Sample Type'}), required=False)
	obs_sample__sample_name = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Sample Name'}), required=False)
	stock__seed_id = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Source Seed ID'}), required=False)
	obs_row__row_id = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Source Row ID'}), required=False)
	obs_plant__plant_id = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Source Plant ID'}), required=False)
	source_sample_id = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Source Sample ID'}), required=False)
	obs_sample__weight = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Weight'}), required=False)
	obs_sample__volume = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Volume'}), required=False)
	obs_sample__density = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Density'}), required=False)
	obs_sample__kernel_num = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Num Kernels'}), required=False)
	obs_sample__photo = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Photo'}), required=False)
	obs_sample__comments = forms.CharField(widget=forms.TextInput(attrs={'placeholder':'Comments'}), required=False)
