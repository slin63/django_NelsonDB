...
class Stock(models.Model):
    ...
    source_plot_male = models.ForeignKey(ObsPlot, related_name="source_plot_male", default=1)
    source_plot_female = models.ForeignKey(ObsPlot, related_name="source_plot_female", default=1)
    planting_year = models.CharField(max_length=30, blank=True)
    pedigree = models.CharField(max_length=200, blank=True)
    pedigree_ID = models.CharField(max_length=200, blank=True)
    maternal_ID = models.CharField(max_length=200, blank=True)
