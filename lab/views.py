			...
			with transaction.atomic():
				try:
					...
					if obs_tracker_samples_form.cleaned_data['obs_plot__plot_id'] != '':
						...
						try:
							obs_tracker_source_plot = ObsTrackerSource.objects.get(target_obs=obs_tracker, source_obs__obs_entity_type='plot', relationship='sample_from_plot')
							obs_tracker_source_plot.source_obs = ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=obs_tracker_samples_form.cleaned_data['obs_plot__plot_id'])
							obs_tracker_source_plot.save()
						except ObsTrackerSource.DoesNotExist:
							new_source_plot = ObsTrackerSource.objects.create(source_obs = ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=obs_tracker_samples_form.cleaned_data['obs_plot__plot_id']), target_obs=obs_tracker, relationship="sample_from_plot")
					else:
						obs_tracker.obs_plot = ObsPlot.objects.get(id=1)
						...
						with transaction.atomic():
							try:
								...
								if experiment_collected == True:
									...
									if plot_id != '':
										source_plot, created = ObsTracker.objects.get_or_create(obs_entity_type='plot', obs_plot=obs_plot)
										new_obs_tracker_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=source_plot, target_obs=new_obs_tracker, relationship='stock_from_plot')
									if plant_id != '':
			...
			if log_data_online_form_set.is_valid():
				...
				for form in log_data_online_form_set:
					try:
						...
						if plot_id != '':
							try:
								obs_tracker = ObsTracker.objects.get(obs_entity_type='plot', obs_plot=ObsPlot.objects.get(plot_id=plot_id))
						...
						try:
							...
							if plot_id !='':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs = ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship="plant_from_plot")
						except Exception as e:
							print("Error: %s %s" % (e.message, e.args))
							failed = True
					except KeyError:
					...
					try:
						...
						try:
							...
							if source_plot_id !='' and source_plot_id != 'No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs = ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=source_plot_id), target_obs=new_obs_tracker, relationship="sample_from_plot")
					...
					try:
						...
						try:
							...
							if plot_id !='' and plot_id !='No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='tissue_from_plot')
				...
				for form in log_data_online_form_set:
					try:
						...
						try:
							...
							if plot_id !='' and plot_id !='No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='culture_from_plot')
				...
				for form in log_data_online_form_set:
					try:
						...
						try:
							...
							if plot_id !='' and plot_id !='No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='microbe_from_plot')
							if tissue_id !='' and tissue_id !='No Tissue':
				...
				for form in log_data_online_form_set:
					try:
						...
						try:
							...
							if plot_id !='' and plot_id != 'No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='dna_from_plot')
							if tissue_id !='' and tissue_id != 'No Tissue':
				...
				for form in log_data_online_form_set:
					try:
						...
						try:
							...
							if plot_id !='' and plot_id != 'No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs= ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='well_from_plot')
							if tissue_id !='' and tissue_id != 'No Tissue':
				...
				for form in log_data_online_form_set:
					try:
						...
						try:
							...
							if plot_id !='' and plot_id !='No Plot':
								new_source_plot, created = ObsTrackerSource.objects.get_or_create(source_obs=ObsTracker.objects.get(obs_entity_type='plot', obs_plot__plot_id=plot_id), target_obs=new_obs_tracker, relationship='isolatestock_from_plot')
							if tissue_id !='' and tissue_id != 'No Tissue':
...
def query_builder_options(request):
	...
	if 'ObsPlot' in selected_options:
		plot_fields_list = [('plot_id', "<select name='qb_plot_id_choice'><option value='' >None</option><option value='obs_plot__plot_id'>Ascending</option><option value='-obs_plot__plot_id'>Descending</option></select>", '<input class="search-query" type="text" name="qb_plot_id" placeholder="Type a Plot ID"/>', 'checkbox_qb_plot'), ('plot_name', "<select name='qb_plot_name_choice'><option value='' >None</option><option value='obs_plot__plot_name'>A to Z</option><option value='-obs_plot__plot_name'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_name" placeholder="Type a Plot Name"/>', 'checkbox_qb_plot'), ('plot_field_name', "<select name='qb_plot_field_name_choice'><option value='' >None</option><option value='field__field_name'>A to Z</option><option value='-field__field_name'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_field_name" placeholder="Type a Field Name"/>', 'checkbox_qb_plot'), ('plot_field_locality_city', "<select name='qb_plot_field_locality_city_choice'><option value='' >None</option><option value='field__locality__city'>A to Z</option><option value='-field__locality__city'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_field_locality_city" placeholder="Type a Locality City"/>', 'checkbox_qb_plot'), ('plot_range_num', "<select name='qb_plot_range_choice'><option value='' >None</option><option value='obs_plot__range_num'>Ascending</option><option value='-obs_plot__range_num'>Descending</option></select>", '<input class="search-query" type="text" name="qb_plot_range" placeholder="Type a Range Num"/>', 'checkbox_qb_plot'), ('plot_plot', "<select name='qb_plot_plot_choice'><option value='' >None</option><option value='obs_plot__plot'>A to Z</option><option value='-obs_plot__plot'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_plot" placeholder="Type a Plot"/>', 'checkbox_qb_plot'), ('plot_block', "<select name='qb_plot_block_choice'><option value='' >None</option><option value='obs_plot__block'>A to Z</option><option value='-obs_plot__block'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_block" placeholder="Type a Block"/>', 'checkbox_qb_plot'), ('plot_rep', "<select name='qb_plot_rep_choice'><option value='' >None</option><option value='obs_plot__rep'>A to Z</option><option value='-obs_plot__rep'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_rep" placeholder="Type a Rep"/>', 'checkbox_qb_plot'), ('plot_kernel_num', "<select name='qb_plot_kernel_num_choice'><option value='' >None</option><option value='obs_plot__kernel_num'>Ascending</option><option value='-obs_plot__kernel_num'>Descending</option></select>", '<input class="search-query" type="text" name="qb_plot_kernel_num" placeholder="Type Kernel Num"/>', 'checkbox_qb_plot'), ('plot_planting_date', "<select name='qb_plot_planting_date_choice'><option value='' >None</option><option value='obs_plot__planting_date'>Ascending</option><option value='-obs_plot__planting_date'>Descending</option></select>", '<input class="search-query" type="text" name="qb_plot_planting_date" placeholder="Type a Planting Date"/>', 'checkbox_qb_plot'), ('plot_harvest_date', "<select name='qb_plot_harvest_date_choice'><option value='' >None</option><option value='obs_plot__harvest_date'>Ascending</option><option value='-obs_plot__harvest_date'>Descending</option></select>", '<input class="search-query" type="text" name="qb_plot_harvest_date" placeholder="Type a Harvest Date"/>', 'checkbox_qb_plot'), ('plot_comments', "<select name='qb_plot_comments_choice'><option value='' >None</option><option value='obs_plot__comments'>A to Z</option><option value='-obs_plot__comments'>Z to A</option></select>", '<input class="search-query" type="text" name="qb_plot_comments" placeholder="Type a Plot Comment"/>', 'checkbox_qb_plot')]
...
def query_builder_fields(request):
	...
	if request.POST.getlist('checkbox_qb_plot', False):
		...
		plot_args = [('plot_id', 'qb_plot_id', 'qb_plot_id_choice', 'obs_plot__plot_id__contains'), ('plot_name', 'qb_plot_name', 'qb_plot_name_choice', 'obs_plot__plot_name__contains'), ('plot_field_name', 'qb_plot_field_name', 'qb_plot_field_name_choice', 'field__field_name__contains'), ('plot_field_locality_city', 'qb_plot_field_locality_city', 'qb_plot_field_locality_city_choice', 'field__locality__city__contains'), ('plot_range_num', 'qb_plot_range', 'qb_plot_range_choice', 'obs_plot__range_num__contains'), ('plot_plot', 'qb_plot_plot', 'qb_plot_plot_choice', 'obs_plot__plot__contains'), ('plot_block', 'qb_plot_block', 'qb_plot_block_choice', 'obs_plot__block__contains'), ('plot_rep', 'qb_plot_rep', 'qb_plot_rep_choice', 'obs_plot__rep__contains'), ('plot_kernel_num', 'qb_plot_kernel_num', 'qb_plot_kernel_num_choice', 'obs_plot__kernel_num__contains'), ('plot_planting_date', 'qb_plot_planting_date', 'qb_plot_planting_date_choice', 'obs_plot__planting_date__contains'), ('plot_harvest_date', 'qb_plot_harvest_date', 'qb_plot_harvest_date_choice', 'obs_plot__harvest_date__contains'), ('plot_comments', 'qb_plot_comments', 'qb_plot_comments_choice', 'obs_plot__comments__contains')]
