...
urlpatterns = patterns('',
    ...
    url(r'^seed_inventory/experiment/collected/(?P<experiment_name>\w+)/$', views.seedinv_collected_from_experiment, name='seedinv_collected_from_experiment'),
    ...
    url(r'^data/measurement/experiment/(?P<experiment_name>\w+)/$', views.measurement_data_from_experiment, name='measurement_data_from_experiment'),
    ...
    url(r'^data/plant/experiment/(?P<experiment_name>\w+)/$', views.plant_data_from_experiment, name='plant_data_from_experiment'),
    ...
    url(r'^download/measurement/experiment/(?P<experiment_name>\w+)', views.download_measurement_experiment, name='download_measurement_experiment'),
    url(r'^download/row/experiment/(?P<experiment_name>\w+)', views.download_row_experiment, name='download_row_experiment'),
    url(r'^download/plant/experiment/(?P<experiment_name>\w+)', views.download_plant_experiment, name='download_plant_experiment'),
