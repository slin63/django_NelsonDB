...
urlpatterns = patterns('',
                       ...
                       url(r'^datatable/iso_inventory/$', views_is.datatable_seed_inventory, name='datatable_seed_inventory'),
                       url(r'^iso_inventory/$', views_is.seed_inventory, name='seed_inventory'),
                       url(r'^iso_inventory/select_taxonomy/$', views_is.select_taxonomy, name='select_taxonomy'),
                       url(r'^iso_inventory/show_all_taxonomy/$', views_is.show_all_seedinv_taxonomy, name='show_all_seedinv_taxonomy'),
                       url(r'^iso_inventory/seed_id_search/$', views_is.seed_id_search, name='seed_id_search'),
                       url(r'^iso_inventory/update/(?P<stock_id>\d+)/$', views_is.update_seed_info, name='update_seed_info'),
                       url(r'^iso_inventory/packet_update/(?P<stock_id>\d+)/$', views_is.update_seed_packet_info, name='update_seed_packet_info'),

                       url(r'^isolate/(?P<isolate_table_id>\d+)/$', views_is.single_isolate_info, name='single_isolate_info'),
