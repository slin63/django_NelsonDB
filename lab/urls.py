...
urlpatterns = patterns('',
    ...
    url(r'^seed_inventory/planted/(?P<experiment_name>\w+)/$', views.seedinv_from_experiment, name='seedinv_from_experiment'),
    url(r'^seed_inventory/collected/(?P<experiment_name>\w+)/$', views.seedinv_collected_from_experiment, name='seedinv_collected_from_experiment'),
