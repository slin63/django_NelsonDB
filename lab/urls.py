...
urlpatterns = patterns('',
    ...
    url(r'^seed/planted/(?P<experiment_name>\w+)/$', views.stock_for_experiment, name='seedinv_from_experiment'),
    url(r'^seed_packets/planted/(?P<experiment_name>\w+)/$', views.seedpackets_for_experiment, name='seedpackets_from_experiment'),
    url(r'^seed/collected/(?P<experiment_name>\w+)/$', views.stock_collected_from_experiment, name='seedinv_collected_from_experiment'),
