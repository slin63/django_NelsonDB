...
urlpatterns = patterns('',
                       ...
                       url(r'^datatable/iso_inventory/$', views_is.datatable_isolatestock_inventory, name='datatable_iso_inventory'),
                       url(r'^iso_inventory/$', views_is.isolatestock_inventory, name='iso_inventory'),
                       url(r'^iso_inventory/select_taxonomy/$', views_is.select_taxonomy, name='select_taxonomy'),
                       url(r'^iso_inventory/show_all_taxonomy/$', views_is.show_all_isolatestock_taxonomy, name='show_all_iso_taxonomy'),
                       url(r'^iso_inventory/isolatestock_id_search/$', views_is.isolatestock_id_search, name='isolatestock_id_search'),
                       url(r'^iso_inventory/update/(?P<isolatestock_id>\d+)/$', views_is.update_isolatestock_info, name='update_iso_info'),
                       url(r'^iso_inventory/select_isolatestocks/$', views_is.select_isolatestocks, name='select_isolatestocks'),
                       ...
                       # url(r'^iso_inventory/select_stocks/$', views_is.select_stockpacket_from_stock, name='select_stockpacket_from_stock'),
                       # url(r'^iso_inventory/select_parameters/$', views_is.select_seedinv_parameters, name='select_seedinv_parameters'),
                       # url(r'^iso_inventory/suggest_pedigree/$', views_is.suggest_pedigree, name='suggest_pedigree'),
                       # url(r'^iso_inventory/suggest_taxonomy/$', views_is.suggest_taxonomy, name='suggest_taxonomy'),
                       # url(r'^iso_inventory/suggest_parameters/$', views_is.seedinv_suggest_parameters, name='seedinv_suggest_parameters'),
                       # url(r'^iso_inventory/show_all_pedigree/$', views_is.show_all_seedinv_pedigree, name='show_all_seedinv_pedigree'),
                       # url(r'^iso_inventory/show_all_parameters/$', views_is.show_all_seedinv_parameters, name='show_all_seedinv_parameters'),
                       # url(r'^iso_inventory/set/(?P<set_type>\w+)/$', views_is.seed_set_download, name='seed_set_download'),
                       # url(r'^iso_inventory/select_pedigree/$', views_is.select_pedigree, name='select_pedigree'),
                       # ---------------

                       url(r'^datatable/isolatestock_inventory/$', views.datatable_isolatestock_inventory, name='datatable_isolatestock_inventory'),
                       url(r'^isolatestock_inventory/$', views.isolatestock_inventory, name='isolatestock_inventory'),
                       url(r'^isolatestock_inventory/suggest_isolatestock_taxonomy/$', views.suggest_isolatestock_taxonomy, name='suggest_isolatestock_taxonomy'),
                       ...
                       url(r'^isolatestock_inventory/show_all_taxonomy/$', views.show_all_isolatestock_taxonomy, name='show_all_isolatestock_taxonomy'),
                       url(r'^isolatestock_inventory/select_isolatestocks/$', views.select_isolatestocks, name='select_isolatestocks'),
                       url(r'^isolatestock_inventory/update/(?P<isolatestock_id>\d+)/$', views.update_isolatestock_info, name='update_isolatestock_info'),
