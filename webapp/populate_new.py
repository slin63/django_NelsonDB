...
#------------------------------------------------------------------------
    ...
    obs_plant_table[(1,1,1,1,'No Plant','No Plant','No Plant')] = 1
    ...
    obs_plant_hash_table[(hash((1,1,1,'No Plant','No Plant','No Plant')))] = 1
...
#---------------------------------------------------------------------
    ...
    for row in experiment_file:
        ...
        experiment_inoc_date1 = row['inoculations_date1']
        experiment_inoc_date2 = row['inoculations_date2']
        experiment_inoc_date3 = row['inoculations_date3']
        ...
        #--- Check/add treatment ---
        if experiment_inoc_date1 != 'NULL':
            treatment_experiment_hash = hash((experiment_hash_table[(experiment_exp_hash)], 'NULL', 'Inoculation', experiment_inoc_date1, 'No Comments'))
            if (treatment_experiment_hash) in treatment_hash_table:
                pass
            else:
                treatment_hash_table[(treatment_experiment_hash)] = treatment_id
                treatment_table[(treatment_id, experiment_hash_table[(experiment_exp_hash)], 'NULL', 'Inoculation', experiment_inoc_date1, 'No Comments')] = treatment_id
                treatment_id = treatment_id + 1
        if experiment_inoc_date2 != 'NULL':
            treatment_experiment_hash = hash((experiment_hash_table[(experiment_exp_hash)], 'NULL', 'Inoculation', experiment_inoc_date2, 'No Comments'))
            if (treatment_experiment_hash) in treatment_hash_table:
                pass
            else:
                treatment_hash_table[(treatment_experiment_hash)] = treatment_id
                treatment_table[(treatment_id, experiment_hash_table[(experiment_exp_hash)], 'NULL', 'Inoculation', experiment_inoc_date2, 'No Comments')] = treatment_id
                treatment_id = treatment_id + 1
            ...
            if (legacy_seed_id) in stock_seed_id_table:
                if (legacy_row_id_origin) in obs_row_intermed_table:
                    if (legacy_plant_id_origin) in legacy_plant_table:
                        ...
                        obs_plant_hash = hash((obs_selector_hash_table[(obs_selector_hash)], obs_row_intermed_table[(legacy_row_id_origin)][0], stock_seed_id_table[(legacy_seed_id)], legacy_plant_id_origin, legacy_plant_name, 'No Comments'))
                        if (obs_plant_hash) in obs_plant_hash_table:
                            pass
                        else:
                            obs_plant_hash_table[(obs_plant_hash)] = obs_plant_id
                ...
                #--- Plant has no row_id ---
                    ...
                    if (legacy_plant_id_origin) in legacy_plant_table:
                        ...
                        obs_plant_hash = hash((obs_selector_hash_table[(obs_selector_hash)], 1, stock_seed_id_table[(legacy_seed_id)], legacy_plant_id_origin, legacy_plant_name, 'No Comments'))
                        if (obs_plant_hash) in obs_plant_hash_table:
                            pass
                        else:
                            obs_plant_hash_table[(obs_plant_hash)] = obs_plant_id
            ...
            #--- Plant has no seed_id ----
                ...
                if (legacy_row_id_origin) in obs_row_intermed_table:
                    if (legacy_plant_id_origin) in legacy_plant_table:
                        ...
                        obs_plant_hash = hash((obs_selector_hash_table[(obs_selector_hash)], obs_row_intermed_table[(legacy_row_id_origin)][0], 1, legacy_plant_id_origin, legacy_plant_name, 'No Comments'))
                        if (obs_plant_hash) in obs_plant_hash_table:
                            pass
                        else:
                            obs_plant_hash_table[(obs_plant_hash)] = obs_plant_id
                ...
                #--- Plant has no seed_id or row_id ---
                    ...
                    if (legacy_plant_id_origin) in legacy_plant_table:
                        ...
                        obs_plant_hash = hash((obs_selector_hash_table[(obs_selector_hash)], 1, 1, legacy_plant_id_origin, legacy_plant_name, 'No Comments'))
                        if (obs_plant_hash) in obs_plant_hash_table:
                            pass
                        else:
                            obs_plant_hash_table[(obs_plant_hash)] = obs_plant_id
...
#------------------------------------------------------------------------
    ...
    for key in measurement_table.iterkeys():
        writer.writerow(key)
    writer = csv.writer(open('data/csv_from_script/treatment.csv', 'wb'))
    for key in treatment_table.iterkeys():
      writer.writerow(key)
