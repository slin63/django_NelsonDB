...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/locality.csv' 
into table lab_locality fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, city, state, country, zipcode);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/field.csv' 
into table lab_field fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, locality_id, field_name);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/experiment.csv' 
into table lab_experiment fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, user_id, field_id, name, start_date, purpose, comments);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/taxonomy.csv' 
into table lab_taxonomy fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, genus, species, population, common_name, alias, race, subtaxa);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/people.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/collecting.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/passport.csv' 
into table lab_passport fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, collecting_id, people_id, taxonomy_id);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/stock.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/disease_info.csv' 
into table lab_diseaseinfo fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, common_name, abbrev, comments);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/obs_row.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/obs_plant.csv' 
into table lab_obsplant fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, obs_selector_id, obs_row_id, plant_id, plant_num, comments);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/location.csv' 
into table lab_location fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, locality_id, building_name, location_name, room, shelf, column, box_name, comments);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/isolate.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/stock_packet.csv' 
into table lab_stockpacket fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, stock_id, location_id, weight, num_seeds, comments);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/measurement_parameter.csv' 
into table lab_measurementparameter fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(id, parameter, parameter_type, protocol, trait_id_buckler);

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/csv_from_script/measurement.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_diseaseinfo_table.csv' 
into table legacy_legacy_diseaseinfo fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(trait, disease_name, abbreviation, topic, disease_info)

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_experiment_table.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_genotype_table.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_isolate_table.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_people_table.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_phenotype_table.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_plant_table.csv' 
into table legacy_legacy_plant fields terminated by ','
enclosed by '"'
lines terminated by '\n'
(plant_id, row_id, plant_name, notes)

load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_row_table_c1.1.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_seed_table_c1.2.csv' 
...
load data local infile 'C://Users/Nick/Documents/GitHub/django_NelsonDB/webapp/data/legacy_data/nelson_lab_seedinv_table.csv' 
